...
# CIFAR10-SVHN
bash scripts/test.sh  CIFAR10-SVHN CIFAR10-SVHN results/joint_confidence_loss/CS-0.001/model_epoch_100.pth 10 3 CS-0.001
bash scripts/test.sh  CIFAR10-SVHN CIFAR10-SVHN results/joint_confidence_loss/CS-0.01/model_epoch_100.pth 10 3 CS-0.01
bash scripts/test.sh  CIFAR10-SVHN CIFAR10-SVHN results/joint_confidence_loss/CS-0.1-6513/model_epoch_100.pth 10 3 CS-0.1
