...
# FashionMNIST
python ./src/run_joint_confidence.py --dataset FashionMNIST --num_classes 8 --num_channels 1 --batch-size 256 --beta 0.001 --outf $save --dataroot ./data   2>&1 | tee  $save/log.txt
